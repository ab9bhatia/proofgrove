...
a single structured log record on the ``proofgrove.events`` logger with a stable
...
logger = logging.getLogger("proofgrove.events")
...
def emit(
    ...
    **fields: Any,
    ...
    render them as first-class keys (see :mod:`proofgrove.logging_config`).
    """
