...
from proofgrove.evaluation.judge_models import filter_judge_model_ids, order_judge_models
...
from proofgrove.evaluation.local_lab import configured_lab_models, local_lab_mode
...
def _catalog_project_id(tenant_id: str) -> str:
    return str(uuid5(NAMESPACE_URL, f"evalai:proofgrove:llm-catalog:{tenant_id}"))
