...
from proofgrove.evaluation.target.catalog import normalize_agent_endpoint, resolve_agent_card_request
...
# Proofgrove can score groundedness for agents whose tool calls are not visible via
...
async def invoke_agent(
    *,
    ...
    with evaluation_root_span(name="proofgrove.invoke_agent", attributes=span_attrs) as invocation_span:
