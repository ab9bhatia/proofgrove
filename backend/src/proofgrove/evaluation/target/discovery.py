...
class AgentSummary(BaseModel):
    ...
    # Stable fingerprint of the discovered Agent generation/spec. Proofgrove uses
    ...
    recommended_dataset_id: str | None = None
...
async def list_tenant_agents(
    *,
    ...
    if not namespace:
        logger.warning("proofgrove: agent discovery skipped — POD_NAMESPACE is unset")
        return []
