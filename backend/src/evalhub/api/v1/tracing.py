...
from evalhub.platform.authz import PERMISSION_EVIDENCE_READ, enforce_tenant, require_permission
from evalhub.platform.contracts import ProjectPurpose
from evalhub.settings import settings
from evalhub.tracing.cost import estimate_span_cost_usd
from evalhub.tracing.scoring import SpanScoringPreviewRequest, SpanScoringRequest, preview_fingerprint, preview_span
...
async def start_span_scoring(
    ...
    if job is not None:
        ...
        from evalhub.evaluation.judge_models import is_judge_model
