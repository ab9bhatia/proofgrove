...
from evalhub.evaluation.model_providers import ENDPOINTS, endpoint_credential, target_provider_problem
from evalhub.evaluation.openinference import content_attributes
from evalhub.evaluation.target.catalog import (
    AgentCatalogError,
...
def _invoke_sync(
    *,
    ...
    with evaluation_root_span(name="eval_hub.invoke_llm", attributes=span_attrs) as invocation_span:
