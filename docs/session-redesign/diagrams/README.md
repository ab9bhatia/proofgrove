...
Visual checks: all ten PNG exports inspected at full size. Text minimum is 22 px in the source. Connector/text crossings and unavailable arrow glyphs were corrected. All element IDs, bindings, text containers and bound elements validate. No StudyMate/booking or original product branding remains in these scenes.
